#using_include
#  takes in arguments of an array and an element and returns true if the array includes that element, 
...
#using_last
# takes in argument of an array and and returns the last element in the array 
